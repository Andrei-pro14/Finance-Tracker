      ...
      <div className="flex flex-col gap-5 w-full p-7 px-22">
        <div className="flex flex-row items-center">
          <div className="flex justify-center items-center w-15 h-8 mr-5 border border-gray-300 border-t-0 border-b-0 border-l-0">
            <div
              className={`flex justify-center items-center w-13 h-6 bg-[#83DB7B] rounded-sm`}
            >
          ...
          <div className="flex gap-2 justify-center items-center">
            <div
              className={`flex justify-center items-center p-2 min-w-13 h-6 bg-[#4CAF50] rounded-sm`}
            >
              <h1 className="text-sm text-white">Utilities</h1>
            </div>
            <div
              className={`flex justify-center items-center p-2 min-w-13 h-6 bg-[#2196F3] rounded-sm`}
            >
        ...
        <div className="flex flex-row items-center">
          <div className="flex justify-center items-center w-15 h-8 mr-5 border border-gray-300 border-t-0 border-b-0 border-l-0">
            <div
              className={`flex justify-center items-center p-2 min-w-10 h-5 bg-[#FFB4A9] rounded-sm`}
            >
          ...
          <div className="flex gap-2 justify-center items-center">
            <div
              className={`flex justify-center items-center p-2 min-w-13 h-6 bg-[#9E9E9E] rounded-sm`}
            >
              <h1 className="text-sm text-white">Cleaning</h1>
            </div>
            <div
              className={`flex justify-center items-center p-2 min-w-13 h-6 bg-[#E91E63] rounded-sm`}
            >
        ...
        <div className="flex flex-row items-center">
          <div className="flex justify-center items-center w-15 h-6 mr-5 border border-gray-300 border-t-0 border-b-0 border-l-0">
            <div
              className={`flex justify-center items-center w-13 h-6 bg-[#FFF2AE] rounded-sm`}
            >
          ...
          <div className="flex gap-2 justify-center items-center">
            <div
              className={`flex justify-center items-center p-2 min-w-13 h-6 bg-[#FF9800] rounded-sm`}
            >
              <h1 className="text-sm text-white">Restaurant</h1>
            </div>
            <div
              className={`flex justify-center items-center p-2 min-w-13 h-6 bg-[#673AB7] rounded-sm`}
            >
              <h1 className="text-sm text-white">Streaming</h1>
            </div>
            <div
              className={`flex justify-center items-center p-2 min-w-13 h-6 bg-[#F44336] rounded-sm`}
            >
        ...
        <div className="flex flex-row items-center">
          <div className="flex justify-center items-center w-15 h-8 mr-5 border border-gray-300 border-t-0 border-b-0 border-l-0">
            <div
              className={`flex justify-center items-center w-13 h-6 bg-[#D2E4FF] rounded-sm`}
            >
          ...
          <div className="flex gap-2 justify-center items-center">
            <div
              className={`flex justify-center items-center p-2 min-w-13 h-6 bg-[#795548] rounded-sm`}
            >
              <h1 className="text-sm text-white">Fuel</h1>
            </div>
            <div
              className={`flex justify-center items-center p-2 min-w-13 h-6 bg-[#607D8B] rounded-sm`}
            >
              <h1 className="text-sm text-white">Insurance</h1>
            </div>
            <div
              className={`flex justify-center items-center p-2 min-w-13 h-6 bg-[#FFC107] rounded-sm`}
            >
